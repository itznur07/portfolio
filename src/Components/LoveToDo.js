...
const Card = ({ icon, name }) => {
  return (
    <div className='md:w-80 w-72 h-48 py-5 bg-[#1d293a] rounded md:flex items-center justify-center cursor-pointer hover:bg-white group transition ease-linear duration-200 border border-[#0eb761] border-opacity-30'>
      <div className="flex flex-col items-center gap-y-5">
        <span className='text-[#0eb761] text-7xl'>{icon}</span>
